...
class NestedIterator2Test {
    ...
    void test1() {
        ...
        NestedIterator2 nestedIterator = new NestedIterator2(Arrays.asList(nestedInteger1, nestedInteger2, nestedInteger3));
    ...
    void test2() {
        ...
        List<Integer> actual = new ArrayList<>();
        NestedIterator2 nestedIterator = new NestedIterator2(new ArrayList<>());
        while (nestedIterator.hasNext()) {
            actual.add(nestedIterator.next());
        }
        assertEquals(ans, actual);
